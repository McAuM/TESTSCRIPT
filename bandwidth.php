...
function write_data_table($caption, $tab)
	...
	$max_tx=0;
		...
		if($tx2 !=0 ){
                ...
                print "<tr>";
                print "<td style=\"text-align: center\" class=\"\">$t</td>";
                print "<td style=\"text-align: right\" class=\"\">$rx</td>";
                print "<td style=\"text-align: right\" class=\"\">$tx</td>";
                print "<td style=\"text-align: right\" class=\"\">$total</td>";
                print "</tr>\n";
             }
        }
        print "</table>\n";
